...
func Catalog() []EventInfo {
	return []EventInfo{
		...
		{Name: "policy.profile_create", Category: "policy", Action: "profile_create", Description: "Custom configuration profile uploaded"},
		{Name: "policy.profile_update", Category: "policy", Action: "profile_update", Description: "Custom profile renamed"},
		{Name: "policy.profile_replace", Category: "policy", Action: "profile_replace", Description: "Custom profile file replaced"},
		{Name: "policy.profile_delete", Category: "policy", Action: "profile_delete", Description: "Custom profile deleted"},
		{Name: "policy.profile_assign", Category: "policy", Action: "profile_assign", Description: "Custom profile assigned to a target"},
		{Name: "policy.profile_unassign", Category: "policy", Action: "profile_unassign", Description: "Custom profile assignment removed"},
		{Name: "policy.timer_create", Category: "policy", Action: "timer_create", Description: "Allowlist timer created"},
		{Name: "policy.timer_update", Category: "policy", Action: "timer_update", Description: "Allowlist timer updated"},
		{Name: "policy.timer_delete", Category: "policy", Action: "timer_delete", Description: "Allowlist timer deleted"},
		{Name: "policy.timer_run", Category: "policy", Action: "timer_run", Description: "Allowlist timer run manually"},
		{Name: "policy.timer_fire", Category: "policy", Action: "timer_fire", Description: "Allowlist timer fired on schedule"},
		...
		{Name: "requests.request_create", Category: "requests", Action: "request_create", Description: "Student access, general, or bug request created"},
		{Name: "requests.request_approve", Category: "requests", Action: "request_approve", Description: "Access request approved"},
		{Name: "requests.request_deny", Category: "requests", Action: "request_deny", Description: "Request denied"},
		{Name: "requests.request_resolve", Category: "requests", Action: "request_resolve", Description: "General or bug ticket marked handled"},
		{Name: "requests.request_message", Category: "requests", Action: "request_message", Description: "Admin or student replied on a request"},
		{Name: "requests.request_reopen", Category: "requests", Action: "request_reopen", Description: "Student reply reopened a closed request"},
		...
		{Name: "credits.access_spend", Category: "credits", Action: "access_spend", Description: "Credits spent to submit an access request"},
		{Name: "credits.access_refund", Category: "credits", Action: "access_refund", Description: "Credits refunded after a denied access request"},
		...
		{Name: "system.api_token_create", Category: "system", Action: "api_token_create", Description: "API token created"},
		{Name: "system.api_token_delete", Category: "system", Action: "api_token_delete", Description: "API token revoked"},
