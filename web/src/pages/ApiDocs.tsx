...
const t = {
  he: {
    ...
    stepAuth: 'שמרו למעלה את אותו אסימון כמו בהגדרות הניהול (מקומית: dev-admin-token). שולחים אותו בכל בקשת ניהול: Authorization: Bearer …',
    ...
    tokenNeeded: 'שמרו אסימון ניהול למעלה כדי לנהל webhooks.',
    events: 'אירועים',
    enabled: 'פעיל',
    test: 'בדיקה',
    deliveries: 'משלוחים',
  ...
  en: {
    ...
    stepAuth: 'Save the same token as Admin → Settings (local default: dev-admin-token). Send it as Authorization: Bearer … on admin routes.',
    ...
    hooksList: 'Endpoints',
    tokenNeeded: 'Save an admin token above to manage webhooks.',
    events: 'Events',
    enabled: 'On',
    test: 'Test',
